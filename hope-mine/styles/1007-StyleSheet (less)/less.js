...
//OWEN HACKS -- BROWSER ONLY!

// the script element which loaded us will be the last one in the document
var scripts = document.getElementsByTagName("script");
var script = scripts[scripts.length-1];

// if "development" attribute is set, or "mode=development", set development mode to on
if (script.getAttribute("development") || script.getAttribute("mode") == "development") {
	less.env = "development";
}
// if "watch" attribute is set, set watch mode to on
if (script.getAttribute("watch")) {
	less.env = "development";
	less.watchMode = true;
}
less.toggleWatch = function(){ this.watchMode = !this.watchMode }
//END OWEN HACKS
