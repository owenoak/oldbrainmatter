...
new hope.Mixin({
	...
	prototype : {
		...
		'get:loaded' : function(){return this.loader.state == hope.LOADED},
		'set:loaded' : function(flag){return this.loader.state = (flag == true ? hope.LOADED : hope.UNLOADED)},
		
		/** Aliases for the load url. */
		'get:src' : function(){return this.loader.url},
		'set:src' : function(url){return this.loader.set("url", url)},

		/** Alias for the load output. */
		'get:data' : function(){return this.loader.output},
		'get:dataType' : function(){return this.loader.outputType},
		'set:dataType' : function(type){return this.loader.set("outputType", type)},
		
		/** Aliases for load/load error messages. */
		'get:loadMessage' : function(){return this.loader.message},
		'set:loadMessage' : function(msg){return this.loader.set("loadMessage", msg)},
		'get:loadErrorMessage' : function(){return this.loader.errorMessage},
		'set:loadErrorMessage' : function(url){this.loader.set("errorMessage", errorMessage)},
	...
	*/
	onMixin : function(it) {
		var loaderName = it.Class.name + "Loader", operation;
		try {
