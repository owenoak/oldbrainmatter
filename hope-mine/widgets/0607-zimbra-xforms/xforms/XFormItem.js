...
XFormItem.prototype.getNormalizedChoices = function () {
	...
	} else if (XFormsUtil.isArray(choices)) {
...
Repeat_XFormItem.prototype.getRemoveButton = function () {
	if(!this.removeButton) {
		this.removeButton = {
			type:_BUTTON_, 
			label: XFormsMsg.xformRepeatRemove, 
			//width:20,
...
Repeat_XFormItem.prototype.getAddButton = function () {
	if(!this.addButton) {
		...
		this.addButton = {
			ref:".",
			type:_BUTTON_, 
			label: XFormsMsg.xformRepeatAdd, 
			onActivate:function (event) {
				var repeatItem = this.getParentItem().getParentItem();
...
//	type defaults
Dwt_Button_XFormItem.prototype.labelLocation = "left" | "center";
...
Button_Grid_XFormItem.prototype.constructWidget = function () {
	...
	var attributes = {
		...
		choices: this.choices ? this.choices.getChoiceObject() : null,
...
//Dwt_Chooser_XFormItem.prototype.widgetClass = DwtChooser;	// CONVERSION?
